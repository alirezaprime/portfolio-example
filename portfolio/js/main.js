// navigation bar effects on scrool
...
const scroolToTopBtn = document.querySelector(".scrolltotop-btn");
window.addEventListener("scroll", function () {
  scroolToTopBtn.classList.toggle("active", window.scrollY > 500);
});
...
const element = document.querySelectorAll(".get-in-touch");
console.log(element);
...
ScrollReveal().reveal(".home .info .btn, .home .info p, .about-info .btn", {
  delay: 200,
  origin: "right",
});
